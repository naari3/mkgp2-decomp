 ...
 * (fn_800DD930) on that ItemObject with value 2, then clear the slot
...
extern void fn_800DD930(void *item, int val); /* ItemObject_SetByte18c */
...
int ISESlot_Deactivate(void *slot) {
    ...
    if (*(int *)((char *)slot + 0x14) != 0x51 &&
        *(void **)((char *)slot + 0x18) != 0) {
        fn_800DD930(*(void **)((char *)slot + 0x18), 2);
    }
    *(void **)((char *)slot + 0x18) = 0;
