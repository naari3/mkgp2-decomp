 ...
 * section in a different order. Emit order below is fixed by the target's
 * section layout; do not sort.
 *
 ...
 *
 * See docs/per_fn_matching_strategy.md §12 (Phase 1b verify outcome) and
